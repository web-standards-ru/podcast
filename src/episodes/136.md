---
date: 2018-09-03
title: 'Chrome не дерзкий, Firefox против трекеров, опенсорс, OpenType, React DOM'
description: 'Chrome не такой дерзкий, Firefox против трекеров, опенсорс и политика, OpenType и полезный каскад, развитие React DOM.'
language: ru
hosts:
  - Вадим Макеев
  - Маша Просвирнина
...
chapters:
  - time: 00:00:39
    title: 'События'
  - time: 00:11:32
    title: 'Chrome не такой дерзкий'
  - time: 00:24:03
    title: 'Firefox против трекеров'
  - time: 00:42:12
    title: 'Опенсорс и политика'
  - time: 01:04:47
    title: 'OpenType и полезный каскад'
  - time: 01:19:41
    title: 'Развитие React DOM'
tags: episode
permalink: false
---
