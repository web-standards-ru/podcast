...
description: 'Node.js, npm и JetBrains, сервис-воркеры и WebAssembly, цена JS и виртуальный список, как понять современный CSS, фокус и доступные псевдоэлементы.'
language: ru
hosts:
  - Вадим Макеев
  - Мария Просвирнина
