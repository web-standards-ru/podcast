---
date: 2019-01-21
title: 'JS в вузах и десять лет назад, браузеры и текст в VR/AR, HTML-модули в JS'
description: 'JavaScript в вузах, JS десять лет назад, браузеры и текст в VR/AR, HTML-модули в JS.'
language: ru
hosts:
  - Вадим Макеев
  - Мария Просвирнина
