---
date: 2016-03-14
title: 'Ожирение сайтов, реклама, jQuery и JavaScript, картинки'
description: '14 марта 2016: Кризис ожирения сайтов, новинки браузеров, Background Sync, статус Grid Layout в Blink, любовное письмо к jQuery, давайте полегче с JavaScript, HTML: что дальше, оформление поломанных картинок, WTF Opera Mini, полифил для object-fit на SVG.'
language: ru
hosts:
  - Ольга Алексашенко
  - Вадим Макеев
