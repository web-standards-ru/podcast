...
date: 2016-12-19
title: 'TITLE'
description: 'Chromium и Opera, position: sticky, виртуальная реальность, приоритизация JS, быстрый параллакс, инлайновый SVG, краткая запись CSS, контрольные точки, гриды и 20 лет CSS.'
language: ru
hosts:
  - Ольга Алексашенко
  - Вадим Макеев
