---
date: 2018-02-19
title: 'Новый фид, вёрстка, зарплата, PWA на десктопе, ES3000, Vue.js вместо jQuery, Node.js 10'
description: 'Новый фид подкаста, эксперименты и основы вёрстки, перегретая зарплата, PWA на десктопе, ECMAScript 3000, Vue.js вместо jQuery, Node.js 10.'
language: ru
hosts:
  - Мария Просвирнина
  - Вадим Макеев
...
chapters:
  - time: 00:00:14
    title: 'События'
  - time: 00:08:04
    title: 'Новый фид подкаста'
  - time: 00:11:46
    title: 'Эксперименты и основы вёрстки'
  - time: 00:20:51
    title: 'Перегретая зарплата'
  - time: 00:30:12
    title: 'PWA на десктопе'
  - time: 00:46:02
    title: 'ECMAScript 3000'
  - time: 01:00:15
    title: 'Vue.js вместо jQuery'
  - time: 01:11:30
    title: 'Node.js 10'
tags: episode
permalink: false
