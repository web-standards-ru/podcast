...
description: '10 лет фронтенда на графике, новинки Firefox 71, WASM 4-й язык веба, лёгкая вставка YouTube, доступный кастомный селект, экономия трафика в CSS, ненавязчивая реклама, WSD всё.'
language: ru
hosts:
  - Вадим Макеев
  - Саша Шинкевич
