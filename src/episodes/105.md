...
description: 'Новинки браузеров, Bootstrap 4, WebStorm и CSS, БЭМ для начинающих, ненужный атрибут title, выражения от контейнера, Веб-стандарты на Литресе, миру мир.'
language: ru
hosts:
  - Мария Просвирнина
  - Ольга Алексашенко
