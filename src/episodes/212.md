...
description: 'Новинки Firefox 72, Shadow Parts в Firefox, новые формы в новом Edge, шаблоны в сервис-воркерах, плиточная раскладка на гридах, ментальная модель JavaScript.'
language: ru
hosts:
  - Вадим Макеев
  - Мария Просвирнина
