...
- [Chrome 135](https://developer.chrome.com/release-notes/135)
- [Modal dialog without a single line of JS](https://codepen.io/matuzo/pen/ByavVrq)
- [HSTS tracking prevention](https://github.com/explainers-by-googlers/HSTS-Tracking-Prevention)
