...
- [Firefox 117 for developers](https://developer.mozilla.org/en-US/docs/Mozilla/Firefox/Releases/117)
- [Firefox DevTools Newsletter](https://fxdx.dev/firefox-devtools-newsletter-117/)

## Прототип form-sizing

- [Intent to Prototype: form-sizing](https://groups.google.com/a/chromium.org/g/blink-dev/c/cA-cmgrA_QE/m/6uF_LYq4AAAJ)
- [Faster Chrome releases (round two!)](https://developer.chrome.com/blog/faster-chrome-releases-round2/)
