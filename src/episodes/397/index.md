...
- [Firefox 120 for developers](https://developer.mozilla.org/en-US/docs/Mozilla/Firefox/Releases/120)
- [Experimental features in Firefox](https://developer.mozilla.org/en-US/docs/Mozilla/Firefox/Experimental_features)
- [-moz-image-rect](https://developer.mozilla.org/en-US/docs/Web/CSS/-moz-image-rect)
...
- [Animating popovers](https://developer.mozilla.org/en-US/docs/Web/API/Popover_API/Using#animating_popovers)
