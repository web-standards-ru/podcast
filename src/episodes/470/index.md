...
- [Documentation Community Group](https://www.w3.org/community/docs-cg/)
...
- [TypeSpec 1.0-RC: Design Faster Today, Scale Easier Tomorrow](https://typespec.io/blog/2025-03-31-typespec-1-0-release/)

## Логические свойства

- [Support logical shorthands in CSS](https://www.oddbird.net/2025/03/20/logical-shorthand/)
- [How do we move logical shorthands forward?](https://www.oddbird.net/2025/03/27/logical-options/)
- [CSS Logical Shorthands on OpenCollective](https://opencollective.com/oddbird-open-source/contribute/css-logical-shorthands-86141)

## Express 5.1

- [Express@5.1.0: Now the default on npm with LTS Timeline](https://expressjs.com/2025/03/31/v5-1-latest-release.html)
- [Grunt Never-Ending Support](https://www.herodevs.com/support/grunt-nes)

## Новый ресет UA+

- [UA+](https://fokus.dev/tools/uaplus/)
- [Tweaking text level styles, reprised](https://adrianroselli.com/2025/04/tweaking-text-level-styles-reprised.html)

## Ответы на вопросы

- [Flowing grid items together](https://github.com/w3c/csswg-drafts/issues/9098)
