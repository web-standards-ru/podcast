...
description: 'События в Ростове-на-Дону, новинки Chrome 74, Node.js 12 и ES-модули, Svelte 3, борьба с оптимизациями V8, пространственная навигация, PWA в Google Play.'
language: ru
hosts:
  - Вадим Макеев
  - Виктор Суздалев
