---
date: 2016-03-09
title: 'Флексы, CSSO, preload и prefetch, HTTP/2, SVG, БЭМ и шаблонизация'
description: '9 марта 2016: Флексбокс — кандидат в рекомендации, определение article, висячая пунктуация, обновлённый CSSO, быстродействие, HTTP/2, блютус в вебе, про SVG по-русски, БЭМ и шаблонизация, шаблонизатор BEM-XJST.'
language: ru
hosts:
  - Вадим Макеев
  - Слава Олиянчук
