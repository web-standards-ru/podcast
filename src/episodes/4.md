---
date: 2016-02-23
title: 'Разработка на мобильных, письма, CSS-переменные, загрузка CSS'
description: '23 февраля 2016: Редакторы и плагины, разработка на мобильных, вёрстка писем, CSS-переменные, альтернативная подгрузка стилей, примеры использования calc.'
language: ru
hosts:
  - Ольга Алексашенко
  - Вадим Макеев
