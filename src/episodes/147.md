---
date: 2018-11-19
title: 'Chrome Dev Summit, API к персональным данным, HTTP/3 на UDP, веб-компоненты'
description: 'Chrome Dev Summit, API к персональным данным, HTTP/3 на UDP, веб-компоненты.'
language: ru
hosts:
  - Вадим Макеев
  - Алексей Симоненко
chapters:
  ...
  - time: 00:36:43
    title: 'API к персональным данным'
  - time: 00:52:10
    title: 'HTTP уже 3'
  - time: 01:13:26
