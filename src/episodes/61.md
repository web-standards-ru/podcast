...
date: 2017-03-27
title: 'TITLE'
description: 'Бета Chrome 58, Safari TP, кастомные свойства в Edge, переключатель на кнопке, гриды на практике, быстрое меню, редактор в браузере, ереси БЭМа, вёрстка для школоты.'
language: ru
hosts:
  - Ольга Алексашенко
  - Вадим Макеев
