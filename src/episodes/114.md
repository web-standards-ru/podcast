...
description: 'Safari 11.1 и 20 лет Mozilla, спеки CSS и доверие к W3C, нюансы display: contents, выравнивание текста, ES-модули уже здесь, новинки WebStorm, React v16.3.0, V8 и веб-сокеты в Node.js, картина отрасли.'
language: ru
hosts:
  - Вадим Макеев
  - Мария Просвирнина
